...
for (vmax_depth in c(4, 6, 8, 10, 12, 14)){
  for (vmin_split in c(1000, 800, 600, 400, 200, 100, 50, 20, 10)){
    for (vminbucket in c(vmin_split/2, vmin_split/4, vmin_split/8)){
      for (vcp in c(-0.0001, -0.2, -0.0007, -0.3)){
    ...
    # vminsplit  minima cantidad de registros en un nodo para hacer el split
         param_basicos <- list(
           ...
           "minsplit" = vmin_split, # mínima cantidad de corte
           "minbucket" = vminbucket, # minima cantidad de registros en una hoja
           "maxdepth" = vmax_depth # representa al eje de las x en la grilla
