...
FErf_attributes_base <- function( pinputexps, ratio, desvio)
{
  ...
  param_local$lgb_param <- list(
    ...
    drop_rate = 0.1,# Corrida general del Workflow Epic
    ...
    wf_septiembre <- function( pnombrewf )
    {
      ...
      fm <- FM_final_models_lightgbm_semillerio( c(ht, ts9), ranks=c(1), semillerio=100, repeticiones_exp=3 )
