...
TS_strategy_base9 <- function( pinputexps )
{
  ...
  param_local$future <- c(202109)
  param_local$final_train <- c(202107, 202106,202105, 202104, 202103, 202102, 202101,202012, 202011, 202010, 202009, 202008, 202007,202002, 202001,201912, 201911,201909, 201908, 201907, 201906,201904, 201903)
