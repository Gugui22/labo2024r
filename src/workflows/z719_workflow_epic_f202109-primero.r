...
TS_strategy_base9 <- function( pinputexps )
{
  ...
  param_local$final_train$training <- c(202107, 202106, 202105, 202104, 202103, 202102,
    202101, 202012, 202011, 202002, 201912, 201911, 201909, 201908, 201907, 201906)


  param_local$train$training <- c(202104, 202103, 202102,
                                  202012, 202011, 202002, 201912, 201911, 201909, 201908, 201907, 201906, 201904, 201903, 201902
                                  , 201901)
  param_local$train$validation <- c(202106)
  param_local$train$testing <- c(202107, 202105, 202101)
